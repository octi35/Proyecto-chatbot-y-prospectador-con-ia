...
export default function AnalyticsPanel({ leads, campaigns, config }: AnalyticsPanelProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* AI Insights — sentiment + actionable highlights (generated by Gemini) */}
      <div className="bg-white rounded-[16px] p-6 sm:p-7 shadow-card">
      ...
      <div className="bg-white rounded-[16px] p-6 ds-shadow flex flex-col md:flex-row items-center justify-between gap-6">
