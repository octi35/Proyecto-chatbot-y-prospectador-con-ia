...
const CHANNELS = [
  {
    ...
    gradient: "from-[#8fd88f] to-[#4caf4c]",
    soft: "bg-[#eafaea] text-[#3f9f3f]",
    initials: "WA",
    steps: [
  ...
  },
  {
    ...
    gradient: "from-pink-500 via-fuchsia-500 to-[#3b5bdb]",
  ...
  },
  {
    ...
    gradient: "from-[#3b5bdb] to-blue-700",
  ...
  },
  {
    ...
    gradient: "from-[#6b7280] to-[#3f3f46]",
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="text-center max-w-2xl mx-auto pt-2 pb-1">
        <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#f5f6ff] text-[#4f6ef7] text-[11px] font-semibold mb-3">
        ...
        <div className="inline-flex items-center gap-2 mt-4 text-[13px] text-[#6b7280]">
          ...
          <div className="flex gap-1 ml-1">
            {CHANNELS.map((c) => (
              <span key={c.id} className={`w-1.5 h-1.5 rounded-full ${isConnected(c.id) ? "bg-[#7dd87d]" : "bg-[#cbd0e0]"}`} />
            ))}
          </div>
        </div>
      </div>
          ...
          return (
            ...
            >
              ...
              <button
                ...
                className="w-full flex items-center gap-4 p-4 sm:p-5 text-left hover:bg-[#f3f5fb]/50 transition-colors cursor-pointer"
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2">
                    ...
                    {connected ? (
                      ...
                      <span className="text-[10px] font-semibold text-[#9ca3af] bg-[#f4f4f5] px-2 py-0.5 rounded-full">
                        Sin conectar
                      </span>
                    )}
                  </div>
                ...
                <ChevronDown size={18} className={`text-[#9ca3af] shrink-0 transition-transform duration-300 ${open ? "rotate-180" : ""}`} />
              </button>
                  ...
                  >
                    <div className="px-4 sm:px-5 pb-5 pt-1 space-y-4 border-t border-[#f4f4f5]">
                      ...
                      <div className="space-y-1.5">
                        <label className="text-[11px] font-semibold text-[#9ca3af] uppercase tracking-wide">URL del Webhook (pegar en Meta)</label>
                      ...
                      <div className="grid sm:grid-cols-2 gap-3">
                        <div className="space-y-1.5">
                          <label className="text-[11px] font-semibold text-[#9ca3af] uppercase tracking-wide">Variables del .env</label>
                          <div className="flex flex-wrap gap-1.5">
                            {ch.envVars.map((v) => (
                              <button
                                key={v}
                                onClick={() => copy(v, v)}
                                className="text-[10px] font-mono font-medium bg-[#f4f4f5] hover:bg-[#e2e5ee] text-[#111111] px-2 py-1 rounded-lg transition-colors cursor-pointer flex items-center gap-1"
                        ...
                        <div className="space-y-1.5">
                          <label className="text-[11px] font-semibold text-[#9ca3af] uppercase tracking-wide">Token de verificación</label>
                          <div className="flex gap-2">
                            <code className="flex-1 bg-[#f4f4f5] text-[#111111] text-[11px] font-mono px-2.5 py-1.5 rounded-lg truncate">
                      ...
                      {/* WhatsApp test */}
                      {ch.id === "whatsapp" && (
                        <div className="bg-[#eafaea]/60 border border-[#dcf5dc] rounded-2xl p-3.5 space-y-2">
                          ...
                          <div className="flex gap-2">
                            ...
                            <button
                              ...
                              className="px-4 py-2 bg-[#4caf4c] hover:bg-[#3f9f3f] disabled:opacity-50 text-white text-[12px] font-semibold rounded-xl flex items-center gap-1.5 cursor-pointer transition-all shrink-0"
                            >
